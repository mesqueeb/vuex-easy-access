...
// test('Wildcard setters 3 (generated by empty state Object props)', t => {
//   // Add items
//   store.set('dex/emptyObject.*', {id: '001', name: 'bulbasaur'})
//   store.commit('dex/emptyObject.*', {id: '004', name: 'charmender'})
//   store.dispatch('dex/set/emptyObject.*', {id: '007', name: 'squirtle'})
//   // add some more to test deletions
//   store.set('dex/emptyObject.*', {id: '002', name: 'ivysaur'})
//   store.set('dex/emptyObject.*', {id: '003', name: 'venusaur'})
//   store.set('dex/emptyObject.*', {id: '005', name: 'charmeleon'})
//   store.set('dex/emptyObject.*', {id: '006', name: 'charizard'})
//   store.set('dex/emptyObject.*', {id: '008', name: 'warturtle'})
//   store.set('dex/emptyObject.*', {id: '009', name: 'blastoise'})
//   // check amount
//   let dex = store.state.dex.emptyObject

//   // make deletions
//   // store.delete('dex/emptyObject', '002') // now ONLY * syntax allowed
//   // t.falsy(dex['002'])
//   store.delete('dex/emptyObject.*', '003')
//   t.falsy(dex['003'])
//   // store.commit('dex/-emptyObject', '005') // now ONLY * syntax allowed
//   // t.falsy(dex['005'])
//   store.commit('dex/-emptyObject.*', '006')
//   t.falsy(dex['006'])
//   // store.dispatch('dex/delete/emptyObject', '008') // now ONLY * syntax allowed
//   // t.falsy(dex['008'])
//   store.dispatch('dex/delete/emptyObject.*', '009')
//   t.falsy(dex['009'])
//   dex = store.state.dex.emptyObject
...
test('Wildcard setters 4 (double wildcards)', t => {
