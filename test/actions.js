...
test('double id setters', t => {
  ...
  const _077 = {id: '077', name: 'Ponyta'}
  store.set('dex/pokemonById.*', _027)
  store.set('dex/pokemonById.*', _043)
  store.set('dex/pokemonById.*', _077)
  let dex = store.state.dex.pokemonById
  t.is(dex[_027.id].name, 'Sandshrew')
  t.is(dex[_043.id].name, 'Oddish')
  t.is(dex[_077.id].name, 'Ponyta')
  store.set('dex/pokemonById.*.tags.*', {id: [_027.id, 'ground'], is: true})
  store.set('dex/pokemonById.*.tags.*', {id: [_043.id, 'grass'], is: true})
  store.set('dex/pokemonById.*.tags.*', {id: [_077.id, 'fire'], is: true})
  store.set('dex/pokemonById.*.tags.*', {id: [_027.id, 'dark'], is: true})
  store.set('dex/pokemonById.*.tags.*', {id: [_043.id, 'dark'], is: true})
  store.set('dex/pokemonById.*.tags.*', {id: [_077.id, 'dark'], is: true})
  t.truthy(dex[_027.id].tags['dark'])
  t.truthy(dex[_043.id].tags['dark'])
  t.truthy(dex[_077.id].tags['dark'])
  t.is(dex[_027.id].tags['dark'].is, true)
  t.is(dex[_043.id].tags['dark'].is, true)
  t.is(dex[_077.id].tags['dark'].is, true)
  store.delete('dex/pokemonById.*.tags.*', {id: [_027.id, 'dark']})
  store.dispatch('dex/delete/pokemonById.*.tags.*', {id: [_043.id, 'dark']})
  store.commit('dex/-pokemonById.*.tags.*', {id: [_077.id, 'dark']})
  t.is(dex[_027.id].name, 'Sandshrew')
  t.is(dex[_043.id].name, 'Oddish')
  t.is(dex[_077.id].name, 'Ponyta')
  ...
  t.is(dex[_027.id].tags['ground'].is, true)
  t.is(dex[_043.id].tags['grass'].is, true)
  t.is(dex[_077.id].tags['fire'].is, true)
